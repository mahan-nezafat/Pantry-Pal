...
const DarkModeButton = ({handleChange, darkMode}) => {
   
    return ( 
        <>
            <div className="container">
  <label className="toggle" htmlFor="switch">
    <input id="switch" className="input-mode" type="checkbox" checked={darkMode} onChange={(e) => handleChange(e)} />
    ...
    <div className="w-8 icon icon--sun flex justify-center items-center">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47.5 47.5" id="sun" width="25" height="25">
        <defs>
          <clipPath id="a">
